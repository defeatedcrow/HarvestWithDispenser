#### Harvest With Dispenser for Minecraft 1.12.2 ####
...
・AgriCraft連携
　AgriCraftの作物を収穫します。種は得られません。

・おまけ
　ついでに機能追加として、バニラ骨粉を5x5の範囲で撒くことができるようになります。
...
　　・羊の毛刈り機能を追加
　　・骨粉の効果を5x5の範囲効果に改変
　　・サボテンやサトウキビの根本を残すようにした

○1.0.6 サーバーサイドのみで動作するようにした
